...
// const userModuleIndex = 'http://api.shopsn.cn/pc/admin.php/' //thinkphp version 3.2
// // const userModuleIndex = 'http://api.shopsn.net/pc/public/index.php/' // thinkphp version 6.0
...
const config = {
    ...
    outLogin: userModuleIndex + 'Register/logOut', // 退出登录
    ...
    // userAuth: userModuleIndex + 'User/userAuth',
    ...
    foRcashAppliation: userModuleIndex + 'CashWithdrawal/cashAppliation', // 提现申请
    getPayRechargeResult: request + 'GetPayType/getPayRechargeResult', // 资金中心-我的账户-余额充值 充值类型
    integralLog: userModuleIndex + 'IntegralUse/getOwnIntegralList',
    ...
    recordDelete: userModuleIndex + 'BalanceRecord/BalanceDel',//我的消息删除记录
    ...
    getDefault: userModuleIndex + 'UserAddress/getDefault',
    ...
    getSAtoreAddress: userModuleIndex + 'StoreAddress/getStoreAddress', // 获取店铺地址
    ...
    // 分销
    distributeAllOrder: userModuleIndex + 'Distribution/orderList',//全部分销订单
    GoodscustomerService: request + 'Order/pendingPayment', // 分销待付款订单
    distributeMyTeam: userModuleIndex + 'Distribution/myTeam',//我的团队
    distributeAccount: userModuleIndex + 'Distribution/presentationDetails',//分销账户
    distributeUserInfo: userModuleIndex + 'Distribution/userInfo',//分销人员信息
    distributeSubmitApply: userModuleIndex + 'Distribution/applyWithdrawal',//分销账户提交申请
    withdrawDetail: userModuleIndex + 'Distribution/presentationDetails',//提现明细
    ...
    package: {
        ...
        GoodscustomerService: userModuleIndex + 'OrderPackageReturnGoods/customerService' // 退货
    },
    // 个人中心 积分订单
    intergral: {
