...
<!--                <img @click="qqLink" src="../assets/img/qq.jpg" />-->
                ...
                <div class="new-show">
                    <div class="downfirst" v-if="storeInfo.name">    
                        <el-dropdown v-if="storeInfo.name">
                            <span class="first-name">{{storeInfo.name}}</span>
            ...
            <!-- <div class="l miaoshu" @click="fun" :class="{ jiantou: up }">
                <p class="l">
                    描述<br />
                    <span>{{
                        storeInfo.StoreCredit.desccredit === undefined
                            ? "0"
                            : storeInfo.StoreCredit.desccredit.toFixed(2) | keep2unit
                    }}</span>
                </p>
                <p class="l">
                    服务<br />
                    <span>{{
                        storeInfo.StoreCredit.servicecredit === undefined
                            ? "0"
                            : storeInfo.StoreCredit.servicecredit.toFixed(2) | keep2unit
                    }}</span>
                </p>
                <p class="l">
                    发货<br />
                ...
                <p class="l">
                    ...
                    <span>{{
                        storeInfo.desccredit === undefined
                            ? "0"
                            : storeInfo.desccredit.toFixed(2) | keep2unit
                    }}</span>
                </p>
                <p class="l">
                    服务<br />
                    <span>{{
                        storeInfo.servicecredit === undefined
                            ? "0"
                            : storeInfo.servicecredit.toFixed(2) | keep2unit
                    }}</span>
                </p>
                <p class="l">
                    发货<br />
        ...
        <!-- <nav v-if="!flag" class="dafault" :style="'background-color:'+navColor "> -->
            <nav v-if="!flag" class="dafault">
    ...
    methods: {
        ...
        getStoreNav() {
            this.HTTP(
                ...
                .then(res => {
                    this.navColor = res.data.data.navColor.color;
                    var list = res.data.data.nav;
                    for (var i in list) {
