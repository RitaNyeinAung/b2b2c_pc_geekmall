<template>
	<div id="interview">
		...
		<div id="logo">
			<div class="center">
				<div class="nake l">
					<p class="Gongpin l"><router-link to="home"><img :src="URL + logoPhoto" /></router-link></p>
					<!-- <p class="iphone l">
				...
				this.HTTP(this.$httpConfig.aboutEtcetera, {}, "post")
					.then(res => {
						...
						sessionStorage.setItem("contentKey", res.data.data.init_key_word);
							let title='企业开店申请'+'-'+ sessionStorage.getItem('titleKey') + '-' +sessionStorage.getItem('updateDescription');
