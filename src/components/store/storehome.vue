<template>
    <div class="home">
        ...
        <div class="center">
            ...
            <div class="picked">推荐商品</div>
            <ul class="bottomul" v-if="storeRecommendGoods != null">
                <li
                    v-if="li != null"
            ...
            <ul v-else class="no_data">暂无数据</ul>
            <!-- <div class="tuijian">
                <span class="l">新品上架</span>
                <span @click="toAll" class="r">更多>></span>
            </div> -->
            <div class="picked">新品上架</div>
            <ul class="bottomul" v-if="storeRecommendGoods != null">
                <li
                    v-if="li != null"
...
export default {
    data() {
        return {
            ...
            showbanner:'',
            headParams: {
                title: sessionStorage.getItem('titleStore'),
                description: sessionStorage.getItem('descriptionStore'),
                keywords: sessionStorage.getItem('keyStore'), 
    ...
    created() {
        ...
        this.getFavIcon(); 
        this.getStoreInfo();
        let title = sessionStorage.getItem('titleStore') + '-' + sessionStorage.getItem('titleKey') + '-' +sessionStorage.getItem('descriptionStore');
    ...
    mounted() {
        ...
        window.setTimeout(function () {
            self.headParams.title = sessionStorage.titleStore
            self.headParams.description = sessionStorage.descriptionStore
            self.headParams.keywords = sessionStorage.keyStore
        ...
        getStoreInfo() {
            this.HTTP(
                ...
                .then(res => {
                    ...
                    sessionStorage.setItem("titleStore",res.data.data.shop_name);
                    sessionStorage.setItem("descriptionStore",res.data.data.description);
                    sessionStorage.setItem("keyStore",res.data.data.description);
                    let title = sessionStorage.getItem('titleStore') + '-' + sessionStorage.getItem('titleKey') + '-' +sessionStorage.getItem('descriptionStore');
                    this.showScroll.scrollTitle(title);
                })
                .catch(() => {});
