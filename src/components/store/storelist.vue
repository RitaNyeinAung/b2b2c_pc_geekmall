  ...
  export default {
    ...
    methods: {
      ...
      block(index, item) {
        ...
        let title = item.class_name + '-' + sessionStorage.getItem('titleKey') + '-' +sessionStorage.getItem('descriptionStore');
        this.showScroll.scrollTitle(title);
      ...
      selecThreeClass(id,type) {
        ...
        if(type == 1){
          this.class_two = id;
          this.class_three = '';
          let title = name + '-' + sessionStorage.getItem('titleKey') + '-' +sessionStorage.getItem('descriptionStore');
          this.showScroll.scrollTitle(title);
        }else {
          this.class_three = id;
          this.class_two = '';
      ...
      getStoreGoodsAllFun() {
        ...
        this.HTTP(this.$httpConfig.getStoreGoodsAll, page , 'post').then((res) => {
          ...
          this.storeGoodsAllList = res.data.data;
          this.page_size = 16;
