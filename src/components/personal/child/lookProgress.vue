                ...
                <div class="progress-info" v-if="personData.length != 0">
                    ...
                    >
                        ...
                        <tr>
                            ...
                            <td class="space">
                                {{ personData.create_time }}
                            </td>
                            <td align="right" class="black border_right">
                                更新时间：
                            </td>
                            <td class="space">
                                {{ personData.update_time }}
                            </td>
                        </tr>
                        <tr>
                            <td align="right" class="black border_right">
                ...
                <div class="progress-info" v-if="companyData.length != 0">
                    ...
                    >
                        ...
                        <tr>
                            ...
                            <td class="space">
                                {{ companyData.create_time }}
                            </td>
                            <td align="right" class="black border_right">
                                更新时间：
                            </td>
                            <td class="space">
                                {{ companyData.update_time }}
                            </td>
                        </tr>
                        <tr>
                            <td align="right" class="black border_right">
...
export default {
    ...
    methods: {
            ...
            this.HTTP(this.$httpConfig.aboutEtcetera, {}, "post")
                .then(res => {
                    ...
                    sessionStorage.setItem("contentKey", res.data.data.init_key_word);
                        let title='查看进度'+'-'+ sessionStorage.getItem('titleKey') + '-' +sessionStorage.getItem('updateDescription');
        ...
        //获取开店信息
        getPerson() {
            this.HTTP(this.$httpConfig.personProgress, {})
                .then(res => {
        ...
        getCompany() {
            this.HTTP(this.$httpConfig.companyProgress,{})
                .then(res => {
