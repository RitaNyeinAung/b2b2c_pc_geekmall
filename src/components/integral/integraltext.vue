  ...
  data() {
    return {
      ...
      headParams: {
          ...
          description: sessionStorage.getItem('DescriptionHot'),
          keywords: sessionStorage.getItem('contentHot'),
  ...
  mounted() {
    ...
    var self = this
        window.setTimeout(function () {
            ...
            self.headParams.description = sessionStorage.DescriptionHot
            self.headParams.keywords = sessionStorage.contentHot
    ...
    getFootData() {
        this.HTTP(this.$httpConfig.aboutEtcetera, {}, "post")
            .then(res => {
                ...
                let title=sessionStorage.getItem('DescriptionHot')+'-'+ sessionStorage.getItem('titleKey') + '-' +sessionStorage.getItem('DescriptionHot');
    ...
    getGoodsDetails() {
      this.HTTP(this.$httpConfig.getGoodsDetails, {
        ...
        .then(res => {
          ...
          sessionStorage.setItem("DescriptionHot", res.data.data.description);
          sessionStorage.setItem("contentHot", res.data.data.title);
          let title=sessionStorage.getItem('DescriptionHot')+'-'+ sessionStorage.getItem('titleKey') + '-' +sessionStorage.getItem('DescriptionHot');
          this.showScroll.scrollTitle(title);
