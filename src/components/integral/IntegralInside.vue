                    ...
                    <div class="dizhi">
                        ...
                        >
                            ...
                            <div class="spec-term-list">
                                <span
                                    ...
                                    <span class="itemcss">{{ d.item }}</span>
                                </span
                                >
                            </div>
                        </div>
                        <!-- <p class="send-to">
                         ...
                         <p class="send-to">
                            ...
                            <input v-if="addressAll == ''" placeholder="请选择地区" type="tel" class="mint-field-core" disabled v-model="defApi_address">
            ...
            <div class="r">手机购买<img src="../../assets/img/samllerweima.jpg" alt="" /></div> -->
                ...
                <div class="r right">
                    ...
                    <div class="l zonghe">
                        ...
                        <p>
                            服务态度
                            <span>{{ shop_data.dservicecredit }}</span>
                        </p>
                        <p>
                            发货速度
...
export default {
    data() {
        return {
            ...
            headParams: {
                ...
                description: sessionStorage.getItem('DescriptionIn'),
                keywords: sessionStorage.getItem('contentIn'),
    ...
    mounted() {
        ...
        window.onscroll = () => {
            ...
            let timer = setTimeout(() => {
                ...
                if (scrollTop > 600 && n < 1) {
                    this.ShopImageDetail(this.goodsData.goods_id);
                    n++;
                }
            }, 500);
        };
        var self = this
            window.setTimeout(function () {
                ...
                self.headParams.description = sessionStorage.DescriptionIn
                self.headParams.keywords = sessionStorage.contentIn
        ...
        getFootData() {
            this.HTTP(this.$httpConfig.aboutEtcetera, {}, "post")
                .then(res => {
                    ...
                    let title=sessionStorage.getItem('DescriptionIn')+'-'+ sessionStorage.getItem('titleKey') + '-' +sessionStorage.getItem('DescriptionIn');
    ...
    this.shipping_data = res.data.data.shipping;
        ...
        comTime() {
            ...
            if (this.goodsData.create_time > now) {
                // this.showTimeType = 0;
                this.getTime(this.goodsData.create_time);
            } else if (now > this.goodsData.create_time && now < this.goodsData.end_time) {
                // this.showTimeType = 1;
                
                this.getTime(this.goodsData.end_time);
            } else {
                // this.showTimeType = 2;
            }
        },
        getTime(value) {
            ...
            this.showTime = day + "天: " + (hour - day * 24) + "时: " + minute + "分：" + getSet + "秒";
        },
        //获取商品信息
        async getGoodsDetails() {
            let res = await this.HTTP(
                this.$httpConfig.IntegralGoodsDetail,
                {
            ...
            if (res.data.status) {
                ...
                sessionStorage.setItem("DescriptionIn", res.data.data.description);
                sessionStorage.setItem("contentIn", res.data.data.title);
                let title=sessionStorage.getItem('DescriptionIn')+'-'+ sessionStorage.getItem('titleKey') + '-' +sessionStorage.getItem('DescriptionIn');
                this.showScroll.scrollTitle(title);
                this.imgList = this.goodsData.images;
                this.defaultPicture = this.goodsData.images[0].pic_url;
                setInterval(this.comTime, 1000);
                await this.getGoodsSpec(this.goodsData.goods_id);
                await this.setup();
