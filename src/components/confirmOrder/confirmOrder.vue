  ...
  <div class="account">
    ...
    <div class="center">
            ...
            <ul class="order-list">
              ...
              <li class="order-info gift-info">
                ...
                <p class="l">
                  ...
                  <span style="color: #dd2727;" v-if="(goodsData.price_member * goodsData.goods_num) >= recductionData.full && recductionData.full">
                ...
                <p v-else-if="deliveryMoney" class="r" style="width: 300px;">
                  <span v-if="goodsData.price_member * goodsData.goods_num>=recductionData.expression">{{goodsData.price_member * goodsData.goods_num - recductionData.expression + deliveryMoney|keep2Num }}</span>
                  <span v-else>{{goodsData.price_member * goodsData.goods_num  + deliveryMoney|keep2Num }}</span>
                  <br>(含配送费：{{deliveryMoney|keep2Num}})
                </p>
								<p v-else-if="freight_price == 0" class="r">卖家包邮</p>
                <p v-else class="r" style="width: 300px;">
                  <span v-if="goodsData.price_member * goodsData.goods_num>=recductionData.expression">{{goodsData.price_member * goodsData.goods_num - recductionData.expression + freight_price|keep2Num }}</span>
                  <span v-else>{{goodsData.price_member * goodsData.goods_num  + freight_price|keep2Num }}</span>
      ...
      <div class="jiesuan">
        ...
        <p v-if="((goodsData.price_member * goodsData.goods_num) >= recductionData.expression) && (recductionData.expression != 0)">满立减 : -{{recductionData.expression}}元</p>
