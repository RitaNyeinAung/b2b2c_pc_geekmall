<template>
	<div class="hotSaleDetail">
		<common-header></common-header>
		<head-com></head-com>
		<div class="center">
			<div class="Guess-body">
                <div v-for="(item,index) in guesshot" :key="index" class="sale_product" @click="entryGoods(item)">
                    <div class="pro_img">
...
<script>
	...
	export default {
		...
		methods: {
			...
			hotSellingGoods() {
                this.HTTP(
                    this.$httpConfig.hotSellingGoods, {}, "post")
                    .then(res => {
                        this.guesshot = res.data.data.data;
