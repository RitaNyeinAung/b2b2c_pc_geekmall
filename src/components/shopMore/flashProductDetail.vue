        ...
        <div id="share">
            <div class="center">
                ...
                <div class="center-page">
                    ...
                    <div class="middle l">
                        <div class="Fsale">
                            <div class="Fsale-title l">FLASH SALE</div>
                            <div class="Fsale-time l">
                                <span class="time-title">剩余时间</span>
                                <span class="time-hour">{{showCountDown}}</span>
                            </div>
                            <div class="Fsale-sold r">
                                <span class="sold-num">{{info.buy_num}}&nbsp;sold</span>
                                <div class="sold-pho">
                                    <div class="sold-show" :style="'width:' + ((info.buy_num/info.activity_num)*100) + '%'"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="peisong">
                            ...
                            >
                                ...
                                <div class="spec-term-list" v-if="item.id == d.spec_id && defaultSpecId == d.id"
                                        v-for="(d, i) in spec.spec_children"
                                        :key="i"
                                        @mouseenter="updateXY(d.item, $event)"
                                        @mouseleave="updataFullFlag">
...
export default {
        ...
        countDownTimer() {
            if(this.countDownTime > 0) {
                setTimeout(() => {
                    ...
                    this.showCountDown = hDisplay + mDisplay + sDisplay;
                    this.countDownTimer()
                }, 1000)
            }
        },
    ...
    getGoodsSpec(id, type) {
        this.HTTP(
            ...
            .then(res => {
                ...
                for(var a in this.specData.goods) {
                    if(this.specData.goods[a].id == this.$route.query.id) {
                        this.defaultSpecId = this.specData.goods[a].key.split("_");
                    }
                }
    ...
    // },
    getMyFootFrint() {
            this.HTTP(this.$httpConfig.getStoreRecommendGoods, { id : this.store_goods_id}, "post")
                .then(res => {
    ...
    //     })
      ...
      getFreightCal1() {
        ...
        pay(id) {
            if (this.me != 0) {
                this.HTTP(
                    this.$httpConfig.getSeckillBuyDetail,
                    {
                        id: id,
                        goods_num: this.me
                    },
        ...
        getDetails(id) {
            this.HTTP(
                this.$httpConfig.getSeckillDetail,
                { goods_id: id },
                "post"
            ).then(res => {
            ...
            .middle {
                ...
                .Fsale{
                    ...
                    .Fsale-title{
                        font-size: 16px;
                        padding: 0 15px;
                        background: linear-gradient(90deg,#d02629,#ff330c);
