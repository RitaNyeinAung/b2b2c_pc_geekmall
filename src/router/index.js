...
import innerGroup from "../components/group/assembleProduct.vue";

//shopMore
import flashSaleDetail from "../components/shopMore/flashSaleDetail.vue";

import flash_product from "../components/shopMore/flashProductDetail.vue";

import guessYouLikeDetail from "../components/shopMore/guessYouLikeDetail.vue";

import hotSaleDetail from "../components/shopMore/hotSaleDetail.vue";

import integralGoodsDetail from "../components/shopMore/integralGoodsDetail.vue";

import newProductDetail from "../components/shopMore/newProductDetail.vue";

import officialStoreDetail from "../components/shopMore/officialStoreDetail.vue";
...
import saleConfirmOrder from "../components/confirmOrder/saleConfirmOrder.vue";
// 支付
...
const router = new Router({
    ...
    routes: [
        ...
        {
            path: "/saleConfirmOrder/:goods_id/:num",
            name: "saleConfirmOrder",
            component: saleConfirmOrder
        },
        // 支付
        {
            path: "/pay",
        ...
        },
        {
            path: "/flash_product",
            name: "flash_product",
            component: flash_product
        },
        {
            path: "/guessYouLikeDetail",
            name: "guessYouLikeDetail",
            component: guessYouLikeDetail
        },
        {
            path: "/hotSaleDetail",
            name: "hotSaleDetail",
            component: hotSaleDetail
        },
        {
            path: "/integralGoodsDetail",
            name: "integralGoodsDetail",
            component: integralGoodsDetail
        },
        {
            path: "/newProductDetail",
            name: "newProductDetail",
            component: newProductDetail
        },
        {
            path: "/officialStoreDetail",
            name: "officialStoreDetail",
            component: officialStoreDetail
        }
    ]
});
